...
public class SteeringBehaviours : MonoBehaviour {
	...
	public bool AmmoCollectionEnabled;
	...
	Vector3 SeekAmmo(Vector3 ammoPos)
	{
		Vector3 desiredVelocity;
		
		desiredVelocity = ammoPos - transform.position;
		desiredVelocity.Normalize();
		desiredVelocity *= maxSpeed;
		return (desiredVelocity - velocity);
		if (ammoPos < 2.0f) 
	...
	void Update () {
		...
		if (AmmoCollectionEnabled)
		{
			force += SeekAmmo(ammoPos);
		}
